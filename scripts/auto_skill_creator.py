...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Auto-Skill Creator - 从复杂任务自动生成 skill",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python auto_skill_creator.py --list
  python auto_skill_creator.py --task '{"type":"task","description":"示例任务"}'
  python auto_skill_creator.py --create
        """
    )
    ...
    if args.evaluate:
        ...
        try:
            ...
            print(f"❌ 格式错误: skill_name,rating (例: my-skill,4)", file=sys.stderr)
            return 1
