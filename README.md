...
# Add a memory
python scripts/evo_main.py remember "Important knowledge to remember"

# Search memories
python scripts/evo_main.py search "keyword"

# Evaluate a skill
python scripts/evo_main.py eval "skill-name,4"

# Run full self-check
python scripts/evo_main.py check
